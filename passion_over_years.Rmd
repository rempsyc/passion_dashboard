...
# x <- "Scotland"
# x <- "Department of Defense, USA, asdfa"
# x <- "Department of Defense, Uniformed Services University of the Health Sciences, Bethesda, NY, 20814"
# x <- "Department of Defense, Uniformed Services University of the Health Sciences, Bethesda, ny, 20814"
# get_country(x, list.countries)
