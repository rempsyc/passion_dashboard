...
get_country <- function(address, list.countries) {
  ...
  if (is.na(country)) {
    country <- rgrep(list.countries, address, value = TRUE, fixed = TRUE)[1]
  }
  if (is.na(country)) {
...
x <- "Department of Defense, Uniformed Services University of the Health Sciences, Bethesda, MD 20814"
